    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="section-title pt-4">
          <p class="text-primary text-uppercase fw-bold mb-3">Daftar Kegiatan</p>
          <h1>Fakultas Seni</h1>
          <p>ikuti kegiatan yang ada di fakultas seni untuk menambah ide dan referensi untuk karya mu. akan banyak pameran seni dan kegiatan lainnya pastikan ke ikut sertaan mu!</p>
        </div>
      </div>
